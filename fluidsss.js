window.onload = function() {
  const canvas1 = document.getElementById("fluidCanvas1");
  ...
  requestAnimationFrame(drawSimulation1);
  }
  ...
  const flowSpeedDisplay = document.getElementById('flowSpeedDisplay');
  ...
  if (speedDisplay) {
  speedDisplay.textContent = `Average Speed: ${avgSpeed.toFixed(2)}`;
  }
  }
